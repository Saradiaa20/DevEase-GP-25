...
class CodeQualityAnalyzer:
    ...
    def _calculate_documentation_score(self) -> float:
        ...
        comment_ratio = (comment_lines + docstring_lines) / self.total_lines
        
        # Score based on comment ratio
        if comment_ratio >= 0.3:  # 30% or more comments
            return 100
        elif comment_ratio >= 0.2:  # 20-30% comments
            return 80
        elif comment_ratio >= 0.1:  # 10-20% comments
            return 60
        elif comment_ratio >= 0.05:  # 5-10% comments
            return 40
        else:  # Less than 5% comments
            return 20
    ...
    def _generate_issues(self, smell_summary: Dict[str, Any]) -> List[str]:
        ...
        if comment_ratio < 0.1:
            issues.append("Low documentation: Less than 10% of lines are comments")
